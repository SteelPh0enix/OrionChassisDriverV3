...
void setup() {
  ...
  // wheel.setPins(Pinout::WheelLF::PWMF, Pinout::WheelLF::PWMB, Pinout::WheelLF::DirectionF,
  // Pinout::WheelLF::DirectionB,
  //               Pinout::WheelLF::FeedbackF, Pinout::WheelLF::FeedbackB);

  // wheel.setPins(Pinout::WheelLR::PWMF, Pinout::WheelLR::PWMB, Pinout::WheelLR::DirectionF,
  // Pinout::WheelLR::DirectionB,
  //               Pinout::WheelLR::FeedbackF, Pinout::WheelLR::FeedbackB);

  // wheel.setPins(Pinout::WheelRF::PWMF, Pinout::WheelRF::PWMB, Pinout::WheelRF::DirectionF,
  // Pinout::WheelRF::DirectionB,
  //               Pinout::WheelRF::FeedbackF, Pinout::WheelRF::FeedbackB);

  wheel.setPins(Pinout::WheelRR::PWMF, Pinout::WheelRR::PWMB, Pinout::WheelRR::DirectionF, Pinout::WheelRR::DirectionB,
                Pinout::WheelRR::FeedbackF, Pinout::WheelRR::FeedbackB);

  wheel.setPowerRampingIntensity(5);
  wheel.setProcessingDelay(200);

  scheduler.addFunction(test_wheels_manager, 3000);
